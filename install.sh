...
TARBALL_URL="https://warehouse.meteor.com/bootstrap/0.8.1.3/meteor-bootstrap-${PLATFORM}.tar.gz"
...
echo
echo "Meteor 0.8.1.3 has been installed in your home directory (~/.meteor)."
